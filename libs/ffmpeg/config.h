...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk/usr/lib/system --target-os=darwin --arch=i386 --cpu=i386 --extra-cflags='-I./x264/build/i386/include -arch i386' --extra-ldflags='-L./x264/build/i386/lib -arch i386' --enable-pic --enable-cross-compile --enable-gpl --enable-libx264 --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-doc --disable-asm"
